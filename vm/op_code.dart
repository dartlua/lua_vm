...
class OpCode{
  ...
  final int opMode;
  final String name;
  final Function(Instruction i, LuaVM vm) action;
...
List<OpCode> opCodes = [
  ...
  OpCode(0, 1, OpArgR, OpArgK, IABC, 'GETTABLE', null),
  OpCode(0, 0, OpArgK, OpArgK, IABC, 'SETTABUP', null),
  OpCode(0, 0, OpArgU, OpArgN, IABC, 'SETUPVAL', null),
  OpCode(0, 0, OpArgK, OpArgK, IABC, 'SETTABLE', null),
  OpCode(0, 0, OpArgU, OpArgU, IABC, 'NEWTABLE', null),
  OpCode(0, 1, OpArgR, OpArgK, IABC, 'SELF', null),
  ...
  OpCode(0, 1, OpArgU, OpArgU, IABC, 'CALL', null),
  OpCode(0, 1, OpArgU, OpArgU, IABC, 'TALLCALL', null),
  OpCode(0, 0, OpArgU, OpArgN, IABC, 'RETURN', null),
